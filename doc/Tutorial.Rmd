...
```
Although requiring less iteration, our function takes a slight more time and memory usage. The potential reason would be our function calls confusion scores function that allows flexibility of averaging methods, thus adding up the computation time.
